...
std::unique_ptr<ColumnWriter> ColumnWriter::createWriterRecursive(
    std::vector<koredb_parquet::format::SchemaElement>& schemas, ParquetWriter& writer,
    ...
    case LogicalTypeID::STRUCT: {
        ...
        koredb_parquet::format::SchemaElement schema_element;
    ...
    case LogicalTypeID::LIST: {
        ...
        koredb_parquet::format::SchemaElement optionalElem;
        ...
        koredb_parquet::format::SchemaElement repeatedElem;
    ...
    case LogicalTypeID::MAP: {
        ...
        // 	}
        // }
        koredb_parquet::format::SchemaElement topElement;
        ...
        // key_value element
        koredb_parquet::format::SchemaElement kv_element;
...
void ColumnWriter::compressPage(common::BufferWriter& bufferedSerializer, size_t& compressedSize,
    ...
    case CompressionCodec::SNAPPY: {
        compressedSize = koredb_snappy::MaxCompressedLength(bufferedSerializer.getSize());
        compressedBuf = std::unique_ptr<uint8_t[]>(new uint8_t[compressedSize]);
        koredb_snappy::RawCompress(reinterpret_cast<const char*>(bufferedSerializer.getBlobData()),
    ...
    case CompressionCodec::ZSTD: {
        compressedSize = koredb_zstd::ZSTD_compressBound(bufferedSerializer.getSize());
        compressedBuf = std::unique_ptr<uint8_t[]>(new uint8_t[compressedSize]);
        compressedSize = koredb_zstd::ZSTD_compress((void*)compressedBuf.get(), compressedSize,
    ...
    case CompressionCodec::LZ4_RAW: {
        compressedSize = koredb_lz4::LZ4_compressBound(bufferedSerializer.getSize());
        compressedBuf = std::unique_ptr<uint8_t[]>(new uint8_t[compressedSize]);
        compressedSize = koredb_lz4::LZ4_compress_default(
            reinterpret_cast<const char*>(bufferedSerializer.getBlobData()),
