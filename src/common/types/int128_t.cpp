...
std::size_t std::hash<koredb::common::int128_t>::operator()(
    const koredb::common::int128_t& v) const noexcept {
    koredb::common::hash_t hash = 0;
    koredb::function::Hash::operation(v, hash);
    return hash;
}
