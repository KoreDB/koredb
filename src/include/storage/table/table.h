...
struct KOREDB_API TableScanState {
    Table* table;
...
struct KOREDB_API TableInsertState {
...
struct KOREDB_API TableUpdateState {
...
struct KOREDB_API TableDeleteState {
    bool logToWAL;
