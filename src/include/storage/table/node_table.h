...
struct KOREDB_API NodeTableScanState : TableScanState {
...
struct KOREDB_API NodeTableInsertState : public TableInsertState {
...
struct KOREDB_API NodeTableUpdateState : TableUpdateState {
    common::ValueVector& nodeIDVector;
...
struct KOREDB_API NodeTableDeleteState : TableDeleteState {
    common::ValueVector& nodeIDVector;
...
class KOREDB_API NodeTable final : public Table {
public:
