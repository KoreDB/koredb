...
struct KOREDB_API RelTableInsertState : TableInsertState {
...
struct KOREDB_API RelTableDeleteState final : TableDeleteState {
    common::ValueVector& srcNodeIDVector;
    common::ValueVector& dstNodeIDVector;
    common::ValueVector& relIDVector;
...
class KOREDB_API RelTable final : public Table {
public:
