...
class KOREDB_API ColumnChunkData {
public:
    ...
    static common::page_idx_t getNumPagesForBytes(uint64_t numBytes) {
        return (numBytes + common::KOREDB_PAGE_SIZE - 1) / common::KOREDB_PAGE_SIZE;
    }
...
class KOREDB_API InternalIDChunkData final : public ColumnChunkData {
public:
