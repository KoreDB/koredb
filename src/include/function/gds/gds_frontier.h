...
class KOREDB_API SparseFrontier : public Frontier {
...
class KOREDB_API DenseFrontier : public Frontier {
...
class KOREDB_API DenseSparseDynamicFrontierPair : public FrontierPair {
public:
...
class KOREDB_API DenseFrontierPair : public FrontierPair {
public:
