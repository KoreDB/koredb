...
struct KOREDB_API RelBatchInsertPrintInfo final : OPPrintInfo {
...
struct KOREDB_API RelBatchInsertProgressSharedState {
...
struct KOREDB_API RelBatchInsertInfo final : BatchInsertInfo {
 ...
 */
class KOREDB_API RelBatchInsertImpl {
public:
...
class KOREDB_API RelBatchInsert : public BatchInsert {
public:
