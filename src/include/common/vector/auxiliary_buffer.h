...
class KOREDB_API AuxiliaryBuffer {
public:
...
class KOREDB_API StructAuxiliaryBuffer : public AuxiliaryBuffer {
public:
...
class KOREDB_API ListAuxiliaryBuffer : public AuxiliaryBuffer {
