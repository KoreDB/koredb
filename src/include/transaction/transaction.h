...
class KOREDB_API LocalCacheObject {
public:
...
extern KOREDB_API Transaction DUMMY_TRANSACTION;
extern KOREDB_API Transaction DUMMY_CHECKPOINT_TRANSACTION;
