...
private:
    ...
    koredb::regex::Regexp* entire_regexp_; // parsed regular expression
    koredb::regex::Regexp* suffix_regexp_; // parsed regular expression, prefix_ removed
...
using koredb::regex::LazyRE2;
using koredb::regex::RE2;
