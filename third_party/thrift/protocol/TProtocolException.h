...
#ifndef _KOREDB_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_
#define _KOREDB_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_ 1
 ...
 *
 */
class TProtocolException : public koredb_apache::thrift::TException {
public:
  /**
  ...
  TProtocolException() : koredb_apache::thrift::TException(), type_(UNKNOWN) {}

  TProtocolException(TProtocolExceptionType type) : koredb_apache::thrift::TException(), type_(type) {}

  TProtocolException(const std::string& message)
    : koredb_apache::thrift::TException(message), type_(UNKNOWN) {}

  TProtocolException(TProtocolExceptionType type, const std::string& message)
    : koredb_apache::thrift::TException(message), type_(type) {}
...
} // koredb_apache::thrift::protocol

#endif // #ifndef _KOREDB_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_
