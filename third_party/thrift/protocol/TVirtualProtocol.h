...
#ifndef _KOREDB_THRIFT_PROTOCOL_TVIRTUALPROTOCOL_H_
#define _KOREDB_THRIFT_PROTOCOL_TVIRTUALPROTOCOL_H_ 1
...
using koredb_apache::thrift::transport::TTransport;
...
public:
  ...
  uint32_t skip(TType type) { return ::koredb_apache::thrift::protocol::skip(*this, type); }
...
public:
  ...
  uint32_t skip(TType type) {
    ...
    return ::koredb_apache::thrift::protocol::skip(*prot, type);
  }
...
#endif // #define _KOREDB_THRIFT_PROTOCOL_TVIRTUALPROTOCOL_H_ 1
