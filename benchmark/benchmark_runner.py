...
koredb_benchmark_tool = os.path.join(
    base_dir, '..', 'build', 'release', 'tools', 'benchmark', 'koredb_benchmark')
...
if __name__ == '__main__':
    ...
    is_success = run_koredb(serialized_graph_path)
