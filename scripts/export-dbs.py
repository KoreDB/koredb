...
# Example scripts/export-dbs.py build/debug/tools/shell/koredb dataset.
def main():
    parser = argparse.ArgumentParser(
        description="Export DBs with KOREDB shell and dataset paths"
    )

    parser.add_argument(
        "--executable", required=True, help="Path to the KOREDB shell executable"
    )
    parser.add_argument(
