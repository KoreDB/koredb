...
--
-- Name: koredb; Type: SCHEMA; Schema: -; Owner: ci
--

CREATE SCHEMA koredb;


ALTER SCHEMA koredb OWNER TO ci;
...
--
-- Name: user; Type: TABLE; Schema: koredb; Owner: ci
--

CREATE TABLE koredb."user" (
    id integer,
...
ALTER TABLE koredb."user" OWNER TO ci;
...
--
-- Data for Name: user; Type: TABLE DATA; Schema: koredb; Owner: ci
--

COPY koredb."user" (id, org, rate) FROM stdin;
5	apple	4
7	ms	5
9	blackberry	7
\.
