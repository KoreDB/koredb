...
class QueryResult:
    ...
    def __init__(self, connection: _koredb.Connection, query_result: _koredb.QueryResult):  # type: ignore[name-defined]
        """
        Parameters
        ----------
        connection : _koredb.Connection
            The underlying C++ connection object from pybind11.

        query_result : _koredb.QueryResult
