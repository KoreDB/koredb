...
/**
 * Union type representing all possible value types in KoreDB.
 */
export type KoreDBValue =
    | null
    | boolean
    | number
    | bigint
...
/**
 * Represents a KoreDB database instance.
 */
export class Database {
    ...
    /**
     * Get the version of the KoreDB library.
     * @returns The version string of the library
     */
    static getVersion(): string;

    /**
     * Get the storage version of the KoreDB library.
...
/**
 * Represents a connection to a KoreDB database.
 */
export class Connection {
    ...
    execute(
        ...
        params?: Record<string, KoreDBValue>,
...
export class QueryResult {
     ...
     */
    getNext(): Promise<Record<string, KoreDBValue> | null>;

    /**
     * Get the next row synchronously.
     * @returns The next row or null if no more rows
     */
    getNextSync(): Record<string, KoreDBValue> | null;
     ...
     */
    each(
        resultCallback: (row: Record<string, KoreDBValue>) => void,
        doneCallback: () => void,
     ...
     */
    getAll(): Promise<Record<string, KoreDBValue>[]>;

    /**
     * Get all rows of the query result synchronously.
     * @returns All rows of the query result
     */
    getAllSync(): Record<string, KoreDBValue>[];
     ...
     */
    all(
        resultCallback: (rows: Record<string, KoreDBValue>[]) => void,
        errorCallback: (error: Error) => void
    ): void;
...
/**
 * Default export for the KoreDB module.
 */
declare const koredb: {
