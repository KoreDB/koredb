...
public class PreparedStatement implements AutoCloseable {
    ...
    private void destroy() {
        checkNotDestroyed();
        Native.koredbPreparedStatementDestroy(this);
        destroyed = true;
    }
    ...
    public boolean isSuccess() {
        checkNotDestroyed();
        return Native.koredbPreparedStatementIsSuccess(this);
    }
    ...
    public String getErrorMessage() {
        checkNotDestroyed();
        return Native.koredbPreparedStatementGetErrorMessage(this);
    }
