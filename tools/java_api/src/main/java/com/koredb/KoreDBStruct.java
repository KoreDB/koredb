...
public class KoreDBStruct implements AutoCloseable {
     ...
     */
    public KoreDBStruct(Value value) {
        structVal = value;
    }
     ...
     */
    public KoreDBStruct(Map<String, Value> fields) {
        if (fields.isEmpty()) {
            structVal = null;
            return;
        }
        ...
        structVal = Native.koredbCreateStruct(fieldNames, fieldValues);
    }
     ...
     */
    public KoreDBStruct(String[] fieldNames, Value[] fieldValues) {
    ...
    public long getNumFields() {
        ...
        return Native.koredbValueGetListSize(structVal);
    }
    ...
    public long getIndexByFieldName(String fieldName) {
        ...
        return Native.koredbValueGetStructIndex(structVal, fieldName);
    }
    ...
    public String getFieldNameByIndex(long index) {
        ...
        return Native.koredbValueGetStructFieldName(structVal, index);
    }
    ...
    public Value getValueByIndex(long index) {
        ...
        return Native.koredbValueGetListElement(structVal, index);
    }
