...
public class QueryResult implements AutoCloseable {
    ...
    private void destroy() {
        checkNotDestroyed();
        if (!isOwnedByCPP) {
            Native.koredbQueryResultDestroy(this);
            destroyed = true;
        }
    }
    ...
    public boolean isSuccess() {
        checkNotDestroyed();
        return Native.koredbQueryResultIsSuccess(this);
    }
    ...
    public boolean isTruncated() {
        checkNotDestroyed();
        return Native.koredbQueryResultIsTruncated(this);
    }
    ...
    public String getTruncationReason() {
        checkNotDestroyed();
        return Native.koredbQueryResultGetTruncationReason(this);
    }
    ...
    public String getErrorMessage() {
        checkNotDestroyed();
        return Native.koredbQueryResultGetErrorMessage(this);
    }
    ...
    public long getNumColumns() {
        checkNotDestroyed();
        return Native.koredbQueryResultGetNumColumns(this);
    }
    ...
    public String getColumnName(long index) {
        checkNotDestroyed();
        return Native.koredbQueryResultGetColumnName(this, index);
    }
    ...
    public DataType getColumnDataType(long index) {
        checkNotDestroyed();
        return Native.koredbQueryResultGetColumnDataType(this, index);
    }
    ...
    public long getNumTuples() {
        checkNotDestroyed();
        return Native.koredbQueryResultGetNumTuples(this);
    }
    ...
    public QuerySummary getQuerySummary() {
        checkNotDestroyed();
        return Native.koredbQueryResultGetQuerySummary(this);
    }
    ...
    public boolean hasNext() {
        checkNotDestroyed();
        return Native.koredbQueryResultHasNext(this);
    }
    ...
    public FlatTuple getNext() {
        checkNotDestroyed();
        return Native.koredbQueryResultGetNext(this);
    }
    ...
    public boolean hasNextQueryResult() {
        checkNotDestroyed();
        return Native.koredbQueryResultHasNextQueryResult(this);
    }
    ...
    public QueryResult getNextQueryResult() {
        checkNotDestroyed();
        return Native.koredbQueryResultGetNextQueryResult(this);
    }
    ...
    public String toString() {
        if (destroyed)
            ...
            return Native.koredbQueryResultToString(this);
    }
    ...
    public void resetIterator() {
        checkNotDestroyed();
        Native.koredbQueryResultResetIterator(this);
    }
}
