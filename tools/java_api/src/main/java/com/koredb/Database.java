...
/**
 * The Database class is the main class of KoreDB. It manages all database
 * components.
 */
public class Database implements AutoCloseable {
    ...
    public Database(String databasePath) {
        ...
        db_ref = Native.koredbDatabaseInit(databasePath, 0, true, false, max_db_size, autoCheckpoint,
                checkpointThreshold);
    }
    ...
    public Database(String databasePath, long bufferPoolSize, boolean enableCompression, boolean readOnly,
        ...
        db_ref = Native.koredbDatabaseInit(databasePath, bufferPoolSize, enableCompression, readOnly, maxDBSize,
    ...
    private void destroy() {
        checkNotDestroyed();
        Native.koredbDatabaseDestroy(this);
        destroyed = true;
    }
}
