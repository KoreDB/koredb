...
public class Value implements AutoCloseable {
    ...
    public <T> Value(T val) {
        checkNotDestroyed();
        v_ref = Native.koredbValueCreateValue(val);
    }
    ...
    public static Value createNull() {
        return Native.koredbValueCreateNull();
    }
    ...
    public static Value createNullWithDataType(DataType data_type) {
        return Native.koredbValueCreateNullWithDataType(data_type);
    }
    ...
    public static Value createDefault(DataType data_type) {
        return Native.koredbValueCreateDefault(data_type);
    }
    ...
    private void destroy() {
        checkNotDestroyed();
        if (!isOwnedByCPP) {
            Native.koredbValueDestroy(this);
            destroyed = true;
        }
    }
    ...
    public boolean isNull() {
        checkNotDestroyed();
        return Native.koredbValueIsNull(this);
    }
    ...
    public void setNull(boolean flag) {
        checkNotDestroyed();
        Native.koredbValueSetNull(this, flag);
    }
    ...
    public void copy(Value other) {
        checkNotDestroyed();
        Native.koredbValueCopy(this, other);
    }
    ...
    public Value clone() {
        if (destroyed)
            ...
            return Native.koredbValueClone(this);
    }
    ...
    public <T> T getValue() {
        checkNotDestroyed();
        return Native.koredbValueGetValue(this);
    }
    ...
    public DataType getDataType() {
        checkNotDestroyed();
        return Native.koredbValueGetDataType(this);
    }
    ...
    public String toString() {
        if (destroyed)
            ...
            return Native.koredbValueToString(this);
    }
}
