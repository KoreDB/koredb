...
/**
 * DataType is the koredb internal representation of data types.
 */
public class DataType implements AutoCloseable {
     ...
     *
     * @param id: the koredb internal representation of data type IDs.
     */
    public DataType(DataTypeID id) {
        dt_ref = Native.koredbDataTypeCreate(id, null, 0);
    }

    public DataType
            (DataTypeID id, DataType child_type, long num_elements_in_array) {
        dt_ref = Native.koredbDataTypeCreate(id, child_type, num_elements_in_array);
    }
    ...
    private void destroy() {
        checkNotDestroyed();
        Native.koredbDataTypeDestroy(this);
        destroyed = true;
    }
    ...
    public DataType clone() {
        if (destroyed)
            ...
            return Native.koredbDataTypeClone(this);
    }
    ...
    public boolean equals(DataType other) {
        checkNotDestroyed();
        return Native.koredbDataTypeEquals(this, other);
    }
    ...
    public DataTypeID getID() {
        checkNotDestroyed();
        return Native.koredbDataTypeGetId(this);
    }
    ...
    public DataType getChildType() {
        checkNotDestroyed();
        return Native.koredbDataTypeGetChildType(this);
    }
    ...
    public long getFixedNumElementsInList() {
        checkNotDestroyed();
        return Native.koredbDataTypeGetNumElementsInArray(this);
    }
