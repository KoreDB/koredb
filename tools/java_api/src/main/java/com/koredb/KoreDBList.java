...
public class KoreDBList implements AutoCloseable {
     ...
     */
    public KoreDBList(Value[] values) {
        listVal = Native.koredbCreateList(values);
    }
     ...
     */
    public KoreDBList(DataType type, long numElements) {
        listVal = Native.koredbCreateList(type, numElements);
    }
    ...
    public long getListSize() {
        ...
        return Native.koredbValueGetListSize(listVal);
    }
    ...
    public Value getListElement(long index) {
        listVal.checkNotDestroyed();
        return Native.koredbValueGetListElement(listVal, index);
    }
