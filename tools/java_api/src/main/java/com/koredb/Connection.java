...
public class Connection implements AutoCloseable {
    ...
    public Connection(Database db) {
        ...
        conn_ref = Native.koredbConnectionInit(db);
    }
    ...
    private void destroy() {
        checkNotDestroyed();
        Native.koredbConnectionDestroy(this);
        destroyed = true;
    }
    ...
    public long getMaxNumThreadForExec() {
        checkNotDestroyed();
        return Native.koredbConnectionGetMaxNumThreadForExec(this);
    }
    ...
    public void setMaxNumThreadForExec(long numThreads) {
        checkNotDestroyed();
        Native.koredbConnectionSetMaxNumThreadForExec(this, numThreads);
    }
    ...
    public QueryResult query(String queryStr) {
        checkNotDestroyed();
        return Native.koredbConnectionQuery(this, queryStr);
    }
    ...
    public PreparedStatement prepare(String queryStr) {
        checkNotDestroyed();
        return Native.koredbConnectionPrepare(this, queryStr);
    }
    ...
    public QueryResult execute(PreparedStatement ps, Map<String, Value> m) {
        checkNotDestroyed();
        return Native.koredbConnectionExecute(this, ps, m);
    }
    ...
    public void interrupt() {
        checkNotDestroyed();
        Native.koredbConnectionInterrupt(this);
    }
    ...
    public void setQueryTimeout(long timeoutInMs) {
        checkNotDestroyed();
        Native.koredbConnectionSetQueryTimeout(this, timeoutInMs);
    }
}
