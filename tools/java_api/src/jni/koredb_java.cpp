...
JNIEXPORT void JNICALL Java_com_koredb_Native_koredbNativeReloadLibrary(JNIEnv* env, jclass,
    jstring libPath) {
    try {
#ifdef _WIN32
// Do nothing on Windows
...
JNIEXPORT jlong JNICALL Java_com_koredb_Native_koredbDatabaseInit(JNIEnv* env, jclass,
...
JNIEXPORT void JNICALL Java_com_koredb_Native_koredbDatabaseDestroy(JNIEnv* env, jclass,
    jobject thisDB) {
    try {
...
JNIEXPORT jlong JNICALL Java_com_koredb_Native_koredbConnectionInit(JNIEnv* env, jclass,
    jobject db) {
...
JNIEXPORT void JNICALL Java_com_koredb_Native_koredbConnectionDestroy(JNIEnv* env, jclass,
    jobject thisConn) {
    try {
...
JNIEXPORT void JNICALL Java_com_koredb_Native_koredbConnectionSetMaxNumThreadForExec(JNIEnv* env,
...
JNIEXPORT jlong JNICALL Java_com_koredb_Native_koredbConnectionGetMaxNumThreadForExec(JNIEnv* env,
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbConnectionQuery(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbConnectionPrepare(JNIEnv* env, jclass,
    jobject thisConn, jstring query) {
    try {
        Connection* conn = getConnection(env, thisConn);
        std::string cppQuery = jstringToUtf8String(env, query);
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbConnectionExecute(JNIEnv* env, jclass,
...
JNIEXPORT void JNICALL Java_com_koredb_Native_koredbConnectionInterrupt(JNIEnv* env, jclass,
    jobject thisConn) {
    try {
        Connection* conn = getConnection(env, thisConn);
        conn->interrupt();
...
JNIEXPORT void JNICALL Java_com_koredb_Native_koredbConnectionSetQueryTimeout(JNIEnv* env, jclass,
...
JNIEXPORT void JNICALL Java_com_koredb_Native_koredbPreparedStatementDestroy(JNIEnv* env, jclass,
    jobject thisPS) {
    try {
...
JNIEXPORT jboolean JNICALL Java_com_koredb_Native_koredbPreparedStatementIsSuccess(JNIEnv* env,
...
JNIEXPORT jstring JNICALL Java_com_koredb_Native_koredbPreparedStatementGetErrorMessage(JNIEnv* env,
    jclass, jobject thisPS) {
    try {
        PreparedStatement* ps = getPreparedStatement(env, thisPS);
...
JNIEXPORT void JNICALL Java_com_koredb_Native_koredbQueryResultDestroy(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
...
JNIEXPORT jboolean JNICALL Java_com_koredb_Native_koredbQueryResultIsSuccess(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jboolean JNICALL Java_com_koredb_Native_koredbQueryResultIsTruncated(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jstring JNICALL Java_com_koredb_Native_koredbQueryResultGetTruncationReason(JNIEnv* env,
    jclass, jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
        return utf8StringToJstring(env, qr->getTruncationReason());
    } catch (const Exception& e) {
        throwJNIException(env, e.what());
    } catch (...) {
        throwJNIException(env, "Unknown Error");
...
JNIEXPORT jstring JNICALL Java_com_koredb_Native_koredbQueryResultGetErrorMessage(JNIEnv* env,
    jclass, jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jlong JNICALL Java_com_koredb_Native_koredbQueryResultGetNumColumns(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jstring JNICALL Java_com_koredb_Native_koredbQueryResultGetColumnName(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbQueryResultGetColumnDataType(JNIEnv* env,
...
JNIEXPORT jlong JNICALL Java_com_koredb_Native_koredbQueryResultGetNumTuples(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbQueryResultGetQuerySummary(JNIEnv* env,
    jclass, jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jboolean JNICALL Java_com_koredb_Native_koredbQueryResultHasNext(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbQueryResultGetNext(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jboolean JNICALL Java_com_koredb_Native_koredbQueryResultHasNextQueryResult(JNIEnv* env,
    jclass, jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbQueryResultGetNextQueryResult(JNIEnv* env,
    jclass, jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jstring JNICALL Java_com_koredb_Native_koredbQueryResultToString(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT void JNICALL Java_com_koredb_Native_koredbQueryResultResetIterator(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
        qr->resetIterator();
...
JNIEXPORT void JNICALL Java_com_koredb_Native_koredbFlatTupleDestroy(JNIEnv* env, jclass,
    jobject thisFT) {
    try {
        jlong fieldValue = env->GetLongField(thisFT, J_C_FlatTuple_F_ft_ref);
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbFlatTupleGetValue(JNIEnv* env, jclass,
...
JNIEXPORT jstring JNICALL Java_com_koredb_Native_koredbFlatTupleToString(JNIEnv* env, jclass,
    jobject thisFT) {
    try {
        FlatTuple* ft = getFlatTuple(env, thisFT);
...
JNIEXPORT jlong JNICALL Java_com_koredb_Native_koredbDataTypeCreate(JNIEnv* env, jclass, jobject id,
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbDataTypeClone(JNIEnv* env, jclass,
    jobject thisDT) {
    try {
...
JNIEXPORT void JNICALL Java_com_koredb_Native_koredbDataTypeDestroy(JNIEnv* env, jclass,
    jobject thisDT) {
    try {
...
JNIEXPORT jboolean JNICALL Java_com_koredb_Native_koredbDataTypeEquals(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbDataTypeGetId(JNIEnv* env, jclass,
    jobject thisDT) {
    try {
        auto* dt = getDataType(env, thisDT);
        std::string idStr = dataTypeToString(*dt);
        jfieldID idField =
            env->GetStaticFieldID(J_C_DataTypeID, idStr.c_str(), "Lcom/koredb/DataTypeID;");
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbDataTypeGetChildType(JNIEnv* env, jclass,
    jobject thisDT) {
    try {
...
JNIEXPORT jlong JNICALL Java_com_koredb_Native_koredbDataTypeGetNumElementsInArray(JNIEnv* env,
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbValueCreateNull(JNIEnv* env, jclass) {
    try {
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbValueCreateNullWithDataType(JNIEnv* env,
...
JNIEXPORT jboolean JNICALL Java_com_koredb_Native_koredbValueIsNull(JNIEnv* env, jclass,
    jobject thisV) {
    try {
...
JNIEXPORT void JNICALL Java_com_koredb_Native_koredbValueSetNull(JNIEnv* env, jclass, jobject thisV,
    jboolean isNull) {
    try {
        Value* v = getValue(env, thisV);
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbValueCreateDefault(JNIEnv* env, jclass,
    jobject dataType) {
    try {
        auto* dt = getDataType(env, dataType);
...
JNIEXPORT jlong JNICALL Java_com_koredb_Native_koredbValueCreateValue(JNIEnv* env, jclass,
    jobject val) {
    try {
        Value* v = nullptr;
        if (env->IsInstanceOf(val, J_C_Boolean)) {
            ...
            int128_t res = 0;
            koredb::function::decimalCast(str.c_str(), str.length(), res, type);
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbValueClone(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
...
JNIEXPORT void JNICALL Java_com_koredb_Native_koredbValueCopy(JNIEnv* env, jclass,
...
JNIEXPORT void JNICALL Java_com_koredb_Native_koredbValueDestroy(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
        Value* v = getValue(env, thisValue);
        delete v;
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbCreateList___3Lcom_koredb_Value_2(
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbCreateList__Lcom_koredb_DataType_2J(
...
JNIEXPORT jlong JNICALL Java_com_koredb_Native_koredbValueGetListSize(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
        Value* v = getValue(env, thisValue);
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbValueGetListElement(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbValueGetDataType(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
        Value* v = getValue(env, thisValue);
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbValueGetValue(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
        Value* v = getValue(env, thisValue);
...
JNIEXPORT jstring JNICALL Java_com_koredb_Native_koredbValueToString(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
        Value* v = getValue(env, thisValue);
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbNodeValGetId(JNIEnv* env, jclass,
    jobject thisNV) {
    try {
...
JNIEXPORT jstring JNICALL Java_com_koredb_Native_koredbNodeValGetLabelName(JNIEnv* env, jclass,
    jobject thisNV) {
    try {
        auto* nv = getValue(env, thisNV);
...
JNIEXPORT jlong JNICALL Java_com_koredb_Native_koredbNodeValGetPropertySize(JNIEnv* env, jclass,
    jobject thisNV) {
    try {
        auto* nv = getValue(env, thisNV);
...
JNIEXPORT jstring JNICALL Java_com_koredb_Native_koredbNodeValGetPropertyNameAt(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbNodeValGetPropertyValueAt(JNIEnv* env,
...
JNIEXPORT jstring JNICALL Java_com_koredb_Native_koredbNodeValToString(JNIEnv* env, jclass,
    jobject thisNV) {
    try {
        auto* nv = getValue(env, thisNV);
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbRelValGetId(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbRelValGetSrcId(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
        auto* rv = getValue(env, thisRV);
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbRelValGetDstId(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
        auto* rv = getValue(env, thisRV);
...
JNIEXPORT jstring JNICALL Java_com_koredb_Native_koredbRelValGetLabelName(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
        auto* rv = getValue(env, thisRV);
...
JNIEXPORT jlong JNICALL Java_com_koredb_Native_koredbRelValGetPropertySize(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
        auto* rv = getValue(env, thisRV);
...
JNIEXPORT jstring JNICALL Java_com_koredb_Native_koredbRelValGetPropertyNameAt(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbRelValGetPropertyValueAt(JNIEnv* env, jclass,
    jobject thisRV, jlong index) {
    try {
        auto* rv = getValue(env, thisRV);
        uint64_t idx = static_cast<uint64_t>(index);
...
JNIEXPORT jstring JNICALL Java_com_koredb_Native_koredbRelValToString(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
        auto* rv = getValue(env, thisRV);
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbCreateMap(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_koredb_Native_koredbCreateStruct(JNIEnv* env, jclass,
...
JNIEXPORT jstring JNICALL Java_com_koredb_Native_koredbValueGetStructFieldName(JNIEnv* env, jclass,
...
JNIEXPORT jlong JNICALL Java_com_koredb_Native_koredbValueGetStructIndex(JNIEnv* env, jclass,
...
JNIEXPORT jstring JNICALL Java_com_koredb_Native_koredbGetVersion(JNIEnv* env, jclass) {
    try {
...
JNIEXPORT jlong JNICALL Java_com_koredb_Native_koredbGetStorageVersion(JNIEnv* env, jclass) {
    try {
...
void initGlobalClassRef(JNIEnv* env) {
    try {
        ...
        createGlobalClassRef(env, J_C_QueryResult, "com/koredb/QueryResult");

        createGlobalClassRef(env, J_C_PreparedStatement, "com/koredb/PreparedStatement");

        createGlobalClassRef(env, J_C_DataType, "com/koredb/DataType");

        createGlobalClassRef(env, J_C_QuerySummary, "com/koredb/QuerySummary");

        createGlobalClassRef(env, J_C_FlatTuple, "com/koredb/FlatTuple");

        createGlobalClassRef(env, J_C_Value, "com/koredb/Value");

        createGlobalClassRef(env, J_C_DataTypeID, "com/koredb/DataTypeID");
        ...
        createGlobalClassRef(env, J_C_InternalID, "com/koredb/InternalID");
        ...
        createGlobalClassRef(env, J_C_Connection, "com/koredb/Connection");

        createGlobalClassRef(env, J_C_Database, "com/koredb/Database");
