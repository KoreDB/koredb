 ...
 * main class of KoreDB. It manages all database components.
 */
"use strict";
...
class Database {
  ...
  constructor(
    ...
    const defaultSystemConfig = new koredb.SystemConfig();
    const systemConfig = new koredb.SystemConfig(
      bufferPoolSize,
      maxNumThreads,
      !!enableCompression,
      !!readOnly,
    ...
    try {
      this._database = new koredb.Database(databasePath, systemConfig);
    } finally {
      systemConfig.delete();
    }
