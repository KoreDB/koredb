# koredb-wasm/sync
Welcome to the documentation of `koredb-wasm`, the WebAssembly build of KoreDB in-process property graph database management system. 
...
For package-level functions, please refer to the documentation of the module `koredb-wasm` from the sidebar.
