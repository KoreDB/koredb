/**
 * @file koredb_wasm_worker.js is the file for the worker thread that wraps around 
...
if (!isWorkerRuntime) {
  ...
  expose({
    ...
    getVersion() {
      return koredbSync.getVersion();
    },

    getStorageVersion() {
      return koredbSync.getStorageVersion();
    },
    ...
    databaseConstruct(databasePath,
      ...
      const id = uuidv4();
      try {
        objectsStore[id] = new koredbSync.Database(
          databasePath,
          bufferPoolSize,
          maxNumThreads,
          enableCompression,
    ...
    connectionConstruct(databaseId, numThreads = null) {
      ...
      const id = uuidv4();
      try {
        objectsStore[id] = new koredbSync.Connection(
