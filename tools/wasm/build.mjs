...
const ES_BUILD_CONFIG = {
  entryPoints: ['./build/sync/index.js', './build/index.js', 'build/koredb_wasm_worker.js'],
  bundle: true,
  format: 'esm',
...
console.log(`Using ${THREADS} threads to build KoreDB.`);
console.log('Cleaning up...');
execSync("npm run clean", { stdio: "inherit" });
console.log('Building single-threaded version of KoreDB WebAssembly module...')
...
console.log("Building multi-threaded version of KoreDB WebAssembly module...");
...
console.log('Cleaning up...');
execSync("npm run clean exclude-package", { stdio: "inherit" });
console.log("Building Node.js version of KoreDB WebAssembly module...");
...
execSync("tar -czf koredb-wasm.tar.gz package", { cwd: path.resolve("."), stdio: "inherit" });
